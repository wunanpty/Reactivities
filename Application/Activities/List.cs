    ...
    public class List
    {
        ...
        public class Handler : IRequestHandler<Query, ActivitiesEnvelope>
        {
            ...
            public async Task<ActivitiesEnvelope> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                {
                    // all of the activities the currently logged in user is going to including the
                    // ones they're hosting because the user will always be going to an activity they're also hosting.
